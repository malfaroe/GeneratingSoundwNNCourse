<<<<<<< HEAD
"""Unit for analysing and comparing the 
quality of reconstruction generated by
the model using samples from the test dataset
"""
import numpy as np
...
def select_images(images, labels, num_images=10):
    """Selects n random images from the test set"""
...
if __name__ == "__main__":
    ...
    # _, latent_representations = autoencoder.reconstruct(sample_images)
    # plot_images_encoded_in_latent_space(latent_representations, sample_labels)
>>>>>>> 1cc5767fe05051fb6107b1804d7ad13843c0f5be
